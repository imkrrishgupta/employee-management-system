  ...
  return (
    <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64'>
            ...
            <div>
                ...
                <NavLink to='/admin-dashboard/leaves' className={({isActive}) => `${isActive ? "bg-[#373A8F]" : " "} flex items-center space-x-4 py-2.5 px-4 rounded-lg`}>
                    <FaCalendarAlt />
                    <span>Leaves</span>
                </NavLink>

                <NavLink to='/admin-dashboard/salary/add' className={({isActive}) => `${isActive ? "bg-[#373A8F]" : " "} flex items-center space-x-4 py-2.5 px-4 rounded-lg`}>
                    <FaMoneyBillWave />
                    <span>Salary</span>
                </NavLink>

                <NavLink to='/admin-dashboard/settings' className={({isActive}) => `${isActive ? "bg-[#373A8F]" : " "} flex items-center space-x-4 py-2.5 px-4 rounded-lg`}>
                    <FaCogs />
                    <span>Settings</span>
                </NavLink>
