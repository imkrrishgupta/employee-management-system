  ...
  return (
    <div className='p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
            ...
            <SummaryCard icon={<FaBuilding />} text="Total Departments" number={5} bgColor="bg-linear-to-b from-amber-200 to-amber-500" />
        ...
        <div className='mt-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
                ...
                <SummaryCard icon={<FaHourglassHalf />} text="Leave Pending" number={4} bgColor="bg-linear-to-b from-amber-200 to-amber-500" />
